...
problem=mlrose.DiscreteOpt(length=50, maximize=True, fitness_fn=mlrose.OneMax())
...
titleStr="One Max - Mean Fitness Value vs No. of Iterations"
plt.title(titleStr)
...
plt.legend(loc='best')
saveFigPath="figures/" + "OneMax-fitnesVsIter-" + ".png"
...
for length in lengths:
    ...
    problem=mlrose.DiscreteOpt(length=length, maximize=True, fitness_fn=mlrose.OneMax())
...
plt.style.use('seaborn-poster')
plt.style.use('ggplot')
titleStr="One Max - Mean Fitness Value vs Problem Length"
plt.title(titleStr)
...
plt.legend(loc='best')
saveFigPath="figures/" + "OneMax-fitnessVal-" + ".png"
plt.savefig(saveFigPath)
plt.clf()
plt.cla()
plt.close()
...
plt.style.use('seaborn-poster')
plt.style.use('ggplot')
titleStr="One Max - Mean Run Time vs Problem Length"
plt.title(titleStr)
plt.xlabel("Problem Length")
...
plt.legend(loc='best')
saveFigPath="figures/" + "OneMax-timeToRun-" + ".png"
plt.savefig(saveFigPath)
plt.clf()
plt.cla()
plt.close()
